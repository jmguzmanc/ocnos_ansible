...
#
# Module to configure OcNOS installed Switches.
# IP Infusion
#
...
from ansible.module_utils.network.ocnos.ocnos import run_commands, load_config, get_config
from ansible.module_utils.network.ocnos.ocnos import ocnos_argument_spec, check_args
